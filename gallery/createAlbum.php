...
<script src="../scripts/bootstrap.min.js"></script>
	...
	<form id="createAlbum" method="post" class="modal-body" enctype="multipart/form-data">
			<h2>Create Album</h2>
			<div>
				<input  maxlength="256" placeholder="Album's Title" style="background:#f3f3f3;border-color:#c2c2c2;width:400px;display:block;" name="title" data-parsley-required="true" type="text" name="title" value="" />
