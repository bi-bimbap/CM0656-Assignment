...
------------------------------------------------------------------------------------------------------------------------->
    <form id="createThreadForm" data-parsley-validate method="post">
          <p>Thread Name: <input type="text" id="txtThreadName" name="txtThreadName" placeholder="Thread Name" /></p>
          <p>Thread Description: <input type="text" id="txtThreadDesc" name="txtThreadDesc" placeholder="Description" /></p>
...
--------------------------------------------------------------------------------------------------------------------------->
<?php
      if(isset($_POST['createThread_submit'])){
        //obtain user input
